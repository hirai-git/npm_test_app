...
def run_query():
   with my_cnx.cursor() as cur:
            ...
            cur.execute("select * from NPMDB_test.NQIUSER1.ATTRIBUTES where SECURITY_CODE='1301' and CALENDAR_DATE between 20220101 and 20221231 order by CALENDAR_DATE")
            return cur.fetchall()
